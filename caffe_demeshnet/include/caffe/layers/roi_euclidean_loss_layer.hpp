#ifndef CAFFE_ROI_EUCLIDEAN_LOSS_LAYER_HPP_
#define CAFFE_ROI_EUCLIDEAN_LOSS_LAYER_HPP_
 ...
 * input to a RoiEuclideanLossLayer exactly formulates a linear least squares
...
class RoiEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit RoiEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "RoiEuclideanLoss"; }
  /**
   * Unlike most loss layers, in the RoiEuclideanLossLayer we can backpropagate
 ...
 protected:
   ...
   *
   * Unlike other children of LossLayer, RoiEuclideanLossLayer \b can compute
